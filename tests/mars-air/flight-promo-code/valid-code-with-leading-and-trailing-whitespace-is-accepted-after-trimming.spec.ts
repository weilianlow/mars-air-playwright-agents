...
// BUG-3: The application does not trim whitespace from the promotional code input.
// Expected: code is trimmed and validated as AF3-FJK-418 (30% discount).
// Actual: "Sorry, code AF3-FJK-418 is not valid" is displayed for " AF3-FJK-418 ".
